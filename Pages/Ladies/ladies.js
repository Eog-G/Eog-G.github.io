document.addEventListener('DOMContentLoaded', () => {
    const ladiesContentContainer = document.getElementById('ladies-content-container');
    ...
    fetch('../../data/ladies.json')
        ...
        .then(data => {
            if (data.pageDescription) {
                ...
                ladiesContentContainer.appendChild(introParagraph);
            }
            ...
            if (data.keyPeople && data.keyPeople.length > 0) {
                ...
                ladiesContentContainer.appendChild(keyPeopleContainer);
            }
            
            const separator1 = document.createElement('hr');
            separator1.className = 'content-separator fade-in-up';
            ladiesContentContainer.appendChild(separator1);
            ...
            if (data.committee && data.committee.length > 0) {
                ...
                ladiesContentContainer.appendChild(committeeSection);
            }
            
            const separator2 = document.createElement('hr');
            separator2.className = 'content-separator fade-in-up';
            ladiesContentContainer.appendChild(separator2);
        ...
        .catch(error => {
            console.error('Error fetching or processing ladies data:', error);
            ladiesContentContainer.innerHTML = '<p>Error loading page content.</p>';
        });
});